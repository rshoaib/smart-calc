...
// CRITICAL: Use SERVICE_ROLE_KEY for inserts to bypass RLS policies
const supabaseUrl = env.NEXT_PUBLIC_SUPABASE_URL;
const supabaseServiceKey = env.SUPABASE_SERVICE_ROLE_KEY;

if (!supabaseUrl || !supabaseServiceKey) {
  console.error("Missing Service Role Key or URL in .env.local");
  process.exit(1);
}
...
async function insertPost() {
  const newPost = {
    ...
    content: articleHtml,
    category: 'Finance',
    date: new Date().toISOString(), // Use raw format, frontend formats it
