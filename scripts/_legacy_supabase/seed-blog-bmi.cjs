...
const article = {
  ...
  title: 'What is a Healthy BMI Range? A Simple Guide for 2026',
  excerpt: 'Understand your Body Mass Index (BMI). Learn what a healthy BMI range is, how it is calculated, and why it is only one part of your overall health picture.',
  category: 'Health',
  date: '2026-03-29',
  ...
  image: '/images/blog/bmi_guide_hero.png',
  content: `Body Mass Index (BMI) is one of the most widely used tools by doctors and health professionals around the world to quickly assess whether a person is at a healthy weight.
...
If you are using the metric system, the formula is:
