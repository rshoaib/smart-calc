---
id: 55
slug: how-much-to-tip-2026-guide
title: "How Much to Tip in 2026: A No-Nonsense Guide for Every Situation"
excerpt: "From restaurants to rideshares, here's exactly how much to tip in 2026 — with quick math, a worked example, and a free calculator to take the guesswork out."
date: 2026-04-28
display_date: "April 28, 2026"
read_time: "8 min read"
category: Productivity
related_tool_link: /productivity/tip-calculator
related_tool_name: "Tip Calculator"
---
...
[Use the Tip Calculator →](/productivity/tip-calculator) to skip the mental math entirely — split a bill, set a custom percentage, and round to whole dollars in one tap.
...
- **For 20%:** move the decimal one place left, then double it. A $48.50 bill → $4.85 → $9.70.
- **For 15%:** take 10% (move the decimal one place left), then add half of that. A $48.50 bill → $4.85 + $2.43 ≈ $7.28.

That works in your head, on a napkin, or with a calculator. If splitting a bill across people is involved — particularly with uneven orders, separate cards, or a group of more than four — that is where mental math falls apart. Saving the receipt photo and running it through a [tip calculator](/productivity/tip-calculator) takes the friction out.
...
- **Hair and barber:** 15–20% of the service total. Tip the stylist directly, even when paying with a card; some salons take a cut of card-based tips.
- **Manicure, pedicure, waxing, facial:** 15–20% of the service.
- **Massage:** 15–20% of the menu price (not any discounted Groupon rate).
- **Hotel housekeeping:** $2–5 per night at a standard hotel, $5–10 per night at a luxury property. Leave it daily in an envelope or marked note — different housekeepers may clean your room across your stay, and a single tip at checkout misses everyone who came before the last person.
- **Hotel bell staff:** $1–2 per bag, with a $5 minimum.
- **Hotel concierge:** $5–20 only when they go beyond directions — securing a hard-to-get reservation or arranging a special request.
- **Valet:** $2–5 when the car is returned.
- **Movers:** $20–40 per mover for a half-day, $40–60 for a full day, more for stairs, heavy items, or a long drive.
- **Furniture and appliance delivery:** $5–20 per person, more if they install or haul away the old item.
- **Pet groomer:** 15–20% of the groom price.
...
- 18% of $84.60 = $84.60 × 0.18 = **$15.23** tip
- New total = $91.37 + $15.23 = **$106.60**
- Per person = $106.60 / 3 = **$35.53**

Two notes. First, tipping on the pre-tax total ($84.60) saves you about $1.22 versus tipping on the after-tax total ($91.37). Both are accepted in 2026; pre-tax is the traditional norm and is still defensible. Second, splitting unevenly when one friend ordered a $14 entrée and another ordered a $34 steak with two cocktails is exactly the case the [Tip Calculator](/productivity/tip-calculator) handles cleanly — split by share rather than by people.

## How to tip without doing the math in your head

Three habits make the awkward moment shorter. **Pick a default and stick with it** — say, 20% on sit-down dining, 15% on takeout and rideshare, $3 minimum on delivery. Decide once; stop deciding. **Round to whole dollars** — tipping $9.70 vs. $10 will not change anyone's life, and it makes splits cleaner. **Use a calculator for splits** — as soon as more than two people or any uneven order is involved, mental math fails most people. A free [Tip Calculator](/productivity/tip-calculator) handles split bills, custom percentages, and rounding in seconds.
