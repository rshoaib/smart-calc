...
export default function EmergencyFundCalculator() {
  ...
  const faqs = [
    { question: 'How much should I have in my emergency fund?', answer: 'Financial experts recommend 3-6 months of essential living expenses. If you have variable income (freelancer, commission-based), are a single-income household, or have dependents, aim for 6-9 months. Start with a $1,000 "starter" emergency fund, then build to your full target. The exact amount depends on your job stability and risk tolerance.' },
    { question: 'Where should I keep my emergency fund?', answer: 'Keep it in a high-yield savings account (HYSA) earning 4-5% APY at online banks like Ally, Marcus, or Wealthfront. Your emergency fund must be liquid (accessible within 1-2 business days) and FDIC-insured. Do NOT invest it in stocks, crypto, or CDs — you need guaranteed, instant access during an emergency, not growth.' },
    { question: 'Should I include optional expenses in my calculation?', answer: 'For a bare-bones "survival" fund, include only essential expenses: housing, food, utilities, insurance, transportation, and minimum debt payments. For a more comfortable fund, add discretionary spending like subscriptions, dining out, and entertainment. Most financial planners recommend calculating both to give yourself a realistic range.' },
    { question: 'What counts as a true emergency?', answer: 'True emergencies include job loss, medical emergencies, essential home repairs (broken furnace, roof leak), urgent car repairs needed for commuting, and unexpected family obligations. Non-emergencies include vacations, planned purchases, annual insurance premiums, or holiday spending — these should have separate "sinking funds" with their own savings buckets.' },
    { question: 'Should I invest my emergency fund or keep it in cash?', answer: 'Keep 3 months of expenses in a HYSA for immediate access. If your fund exceeds 6 months, you could invest the excess in low-risk, liquid assets like Treasury bills or a conservative bond fund. However, the primary purpose of an emergency fund is capital preservation, not growth — losing 10-20% in a market downturn right when you lose your job defeats the purpose.' },
  ];
