...
export default function FireCalculator() {
  ...
  const faqs = [
    { question: 'What is FIRE?', answer: 'FIRE stands for Financial Independence, Retire Early. It is a movement focused on extreme savings (50-70% of income) and disciplined investing to build enough wealth to retire decades before the traditional age of 65. FIRE does not necessarily mean never working again — it means working becomes optional because your investments cover your living expenses.' },
    { question: 'What is the FIRE number?', answer: 'Your FIRE number is your annual spending divided by your safe withdrawal rate (typically 4%). For example, if you spend $40,000/year: $40,000 ÷ 0.04 = $1,000,000. This means you need $1 million invested to sustain $40,000/year indefinitely. Reducing your annual spending by just $5,000 lowers your FIRE number by $125,000.' },
    { question: 'What is a safe withdrawal rate?', answer: 'The safe withdrawal rate (SWR) is the percentage of your portfolio you can withdraw annually without running out of money over a 30+ year retirement. The Trinity Study (1998) established 4% as sustainable for a 60/40 stock/bond portfolio. More conservative planners use 3.5% for early retirees (40+ year retirement), while optimistic projections may use 4.5%.' },
    { question: 'What are the different types of FIRE?', answer: 'Lean FIRE targets under $40K/year spending (minimalist lifestyle). Regular FIRE targets $40K-$100K/year. Fat FIRE targets $100K+/year (maintaining a comfortable lifestyle). Barista FIRE means reaching partial financial independence and working a low-stress part-time job for benefits and supplemental income. Coast FIRE means having enough invested early that you never need to save again.' },
    { question: 'How does inflation affect my FIRE plan?', answer: 'At 3% inflation, $1 million today is worth only $554K in 20 years in purchasing power. This calculator lets you toggle between "Real Value" (today\'s dollars, inflation-adjusted) and "Nominal Value" (future dollar amounts). Always plan in real terms — if your annual spending is $40K today, you will need $72K nominally in 20 years at 3% inflation to maintain the same lifestyle.' },
  ];
