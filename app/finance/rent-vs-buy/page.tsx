...
export default function RentVsBuyCalculator() {
  ...
  const faqs = [
    { question: 'Is it better to rent or buy a home?', answer: 'It depends on how long you plan to stay, local market conditions, and your financial situation. Generally, buying becomes financially advantageous after 5-7 years due to equity building and rent inflation. However, in expensive markets with low rent-to-price ratios (like San Francisco or NYC), renting and investing the difference can be superior for 10+ years.' },
    { question: 'What is the breakeven point?', answer: 'The breakeven point is when buying becomes financially better than renting, accounting for all costs. It factors in home appreciation, mortgage interest, maintenance costs (1% of home value/year), property taxes, insurance, and the opportunity cost of your down payment invested elsewhere. Most markets see a 5-8 year breakeven, but this varies dramatically by location.' },
    { question: 'What hidden costs does buying a home have?', answer: 'Buyers face closing costs (2-5% of purchase price), property taxes (~1-2% annually), homeowners insurance (~0.5-1%), maintenance and repairs (1-2% of home value annually), HOA fees ($200-500/month in some areas), and selling costs (5-6% when you sell). These "hidden" costs total 3-5% of home value per year and are often underestimated by first-time buyers.' },
    { question: 'What is the opportunity cost of a down payment?', answer: 'Your down payment could be invested in the stock market instead. If you put $80,000 down on a home, that money could potentially earn 7-10% annually in index funds. This calculator models this — the renter\'s net worth includes investment returns on the money they did not spend on a down payment and closing costs. Over 30 years, $80K invested at 7% grows to over $600K.' },
    { question: 'Does the 5-year rule still apply?', answer: 'The "5-year rule" (buy only if staying 5+ years) is a reasonable guideline but oversimplified. In markets with high appreciation (3-5%/year), breakeven can be 3-4 years. In flat markets or high-cost areas, it may take 8-10 years. This calculator lets you model your specific scenario with actual numbers rather than relying on rules of thumb.' },
  ];
                     ...
                     <div className="h-[400px] w-full">
                         <ResponsiveContainer width="100%" height="100%">
                             <LineChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                                 ...
                                 <Tooltip 
                                     formatter={(value: unknown) => [value !== undefined ? `$${Number(value).toLocaleString()}` : '', '']}
