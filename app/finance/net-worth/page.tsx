...
const meta = {
    ...
    description:
        'Calculate your total net worth by adding up assets and subtracting liabilities. Track this number quarterly to see whether you\'re actually getting wealthier.',
};
