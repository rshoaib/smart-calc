...
import { percentagePages, tipPages, discountPages, agePages, salaryPages, mortgagePages, bmiPages, convertPages } from '@/data/seoTemplates';
import SeoCalculatorPage from '@/components/SeoCalculatorPage'

/**
 * Unified SEO Route Handler
 * Matches /calculate/:slug to the correct page type from all data arrays.
 */
export default function SeoRouteHandler() {
  const { slug } = useParams<{ slug: string }>();
  if (!slug) { redirect("/"); }

  // Check percentage pages
  ...
  // No match found
  redirect("/productivity/percentage");
}
