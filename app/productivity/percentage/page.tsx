...
const meta = {
    ...
    title: 'Percentage Calculator: % of, % Change, % Difference',
    description:
        'Three calculators in one: find a percentage of a number, calculate percent change, and percent difference between two numbers.',
};
