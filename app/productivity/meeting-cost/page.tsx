...
const meta = {
    ...
    title: 'Meeting Cost Calculator (Real-Time Burn Rate)',
    description:
        'Track the real-time dollar cost of any meeting based on attendee salaries. Watch the meter run during your next 60-minute review.',
};
