...
export default function MacroCalculator() {
  ...
  const faqs = [
    { question: 'What are macros?', answer: 'Macros (macronutrients) are the three main nutrients your body needs in large amounts: protein (4 cal/g) for muscle repair and immune function, carbohydrates (4 cal/g) for energy and brain function, and fats (9 cal/g) for hormone production and nutrient absorption. Together they make up your total calorie intake.' },
    { question: 'What is the best macro ratio?', answer: 'A balanced diet is typically 30% protein, 40% carbs, 30% fat. Athletes and bodybuilders may prefer 40-50% protein. Endurance athletes need 50-60% carbs. Keto dieters use 70% fat, 25% protein, 5% carbs. The "best" ratio depends on your goals (muscle gain, fat loss, athletic performance) and individual response.' },
    { question: 'How much protein do I need per day?', answer: 'For general health, aim for 0.8g per kg of body weight (RDA minimum). For muscle building, research suggests 1.6-2.2g per kg. For fat loss while preserving muscle, aim for 1.8-2.7g per kg. Spread intake across 3-5 meals for optimal absorption — your body can only utilize about 30-40g of protein per meal for muscle synthesis.' },
    { question: 'Should I track macros or just calories?', answer: 'Tracking macros is more effective than counting only calories because body composition depends on what you eat, not just how much. Two diets at 2,000 calories can produce very different results: one high in protein builds muscle, while one high in sugar promotes fat storage. For weight loss alone, calories matter most; for body composition, macros are essential.' },
    { question: 'What is the keto diet and who is it for?', answer: 'Keto is a very low-carb, high-fat diet (typically 70% fat, 25% protein, 5% carbs) that puts your body into ketosis — burning fat for fuel instead of glucose. It can be effective for rapid weight loss and managing type 2 diabetes. However, it is not ideal for high-intensity athletes, and long-term adherence is difficult. Always consult a healthcare provider before starting keto.' },
  ];
