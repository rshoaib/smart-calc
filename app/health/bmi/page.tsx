...
export default function BMICalculator() {
  ...
  const faqs = [
    { question: 'What is BMI?', answer: 'BMI (Body Mass Index) is a simple screening tool that uses your height and weight to estimate body fat. The metric formula is weight (kg) divided by height (m) squared. The imperial formula is 703 × weight (lbs) ÷ height (inches) squared. It was developed by Belgian mathematician Adolphe Quetelet in 1832 and is widely used by healthcare providers.' },
    { question: 'What is a healthy BMI range?', answer: 'A BMI of 18.5 to 24.9 is considered normal weight. Below 18.5 is underweight (risk of malnutrition), 25-29.9 is overweight (elevated health risks), and 30+ is obese (significantly increased risk of diabetes, heart disease, and joint problems). These ranges are defined by the WHO and may vary slightly for different ethnic groups.' },
    { question: 'Is BMI accurate for everyone?', answer: 'BMI does not distinguish between muscle and fat mass. Athletes and bodybuilders may have a high BMI but low body fat (false positive). Conversely, elderly people may have a normal BMI but high body fat (false negative). For a more complete picture, combine BMI with waist circumference, body fat percentage, or a DEXA scan.' },
    { question: 'How does BMI differ for children and teens?', answer: 'For children and teens (ages 2-19), BMI is interpreted using age- and sex-specific percentiles called BMI-for-age. A BMI at the 85th to 94th percentile is overweight, and at or above the 95th percentile is obese. Adult BMI cutoffs should not be applied to children.' },
    { question: 'What is the relationship between BMI and health risks?', answer: 'Higher BMI is associated with increased risk of type 2 diabetes, cardiovascular disease, hypertension, certain cancers, and sleep apnea. However, BMI alone is not diagnostic — factors like diet quality, physical activity, waist circumference, and family history also play important roles in overall health risk assessment.' },
  ];
