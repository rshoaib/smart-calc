...
const meta = {
    ...
    title: 'Heart Rate Zone Calculator with Zone 2 Range',
    description:
        'Calculate your five heart rate training zones from your max HR, including the popular Zone 2 endurance range. Karvonen and standard methods.',
};
